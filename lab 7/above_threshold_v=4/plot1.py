...
if __name__ == "__main__":
    ...
    Data2 = plt.plot(Vdm4, I1V4, 'bo', markersize=3, label="I1, V2 = 4")

    Data5 = plt.plot(Vdm4, I2V4, 'ko', markersize=3, label="I2, V2 = 4")

    Data8 = plt.plot(Vdm4, Sum4, 'ro', markersize=3, label="I1 - I2, V2 = 4")

    Data9 = plt.plot(Vdm4, Diff4, 'co', markersize=3, label="I1 + I2, V2 = 4")

    mOffset = 10;
    Date11 = plt.plot(Vdm4[mOffset:len(line4)-mOffset], line4[mOffset:len(line4)-mOffset], 'go',  markersize=3, label="slope = Gdm, V2=4")
