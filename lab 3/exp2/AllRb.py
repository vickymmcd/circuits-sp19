...
Data4 = plt.loglog(I_b_100[1:len(I_b_100)], Theo_Rb_100[1:len(Theo_Rb_100)], 'c--', markersize=4, label="R = 100 Ohm Theoretical")
Data5 = plt.loglog(I_b_1K[1:len(I_b_1K)], Theo_Rb_1K[1:len(Theo_Rb_1K)], 'm--', markersize=4, label="R = 1K Ohm Theoretical")
Data6 = plt.loglog(I_b_10K[2:len(I_b_10K)], Theo_Rb_10K[2:len(Theo_Rb_10K)], 'k--', markersize=4, label="R = 10K Ohm Theoretical")
