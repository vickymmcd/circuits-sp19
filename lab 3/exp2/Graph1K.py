...
Data1 = plt.plot(V_b_1K, I_c_1K, 'bo', markersize=3, label="R = 1K Ohm")
Data2 = plt.plot(V_b_1K, Theo_1K, 'k--', markersize=3, label="Theoretical Fit")
